...
const std::string &GetMethod::path(int index)
{
    assert(index >= 0 && index < m_paths.size());
    return m_paths[index];
}

void GetMethod::call(int index, const HttpRequest &req, HttpResponse *resp)
{
    ...
    case 0: {
        ...
        resp->setBody("<html><head><title>This is title</title></head>"
                      "<body><h1>Hello</h1>This is Http GET Method</body></html>");
    } break;
    case 1:
        resp->setStatusCode(HttpResponse::k200Ok);
        resp->setStatusMessage("OK");
